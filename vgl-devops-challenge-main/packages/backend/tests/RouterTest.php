...
{
    /**
     * @return array{0: EntityManagerInterface, 1: Artist, 2: Album, 3: Router}
     */
    ...
    public function testHealthRouteReturnsOk(): void
    {
        ...
        $req = new Request(['request_method' => 'GET', 'request_uri' => '/health']);
        $res = new Response();
    ...
    {
        [$em, , , $router] = $this->makeRouterWithFixtures();
        $req = new Request(['request_method' => 'GET', 'request_uri' => '/artists']);
        $res = new Response();
        $router->handle($req, $res);
        $this->assertSame(200, $res->statusCode);
    ...
    public function testAlbumGetReturnsNestedArtist(): void
    {
        ...
        $req = new Request(['request_method' => 'GET', 'request_uri' => '/albums/' . $album->getId()]);
        $res = new Response();
        $router->handle($req, $res);
        $this->assertSame(200, $res->statusCode);
        $json = json_decode($res->body, true);
